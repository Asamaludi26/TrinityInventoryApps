        ...
        <div className="p-6 space-y-6">
          ...
          <div className="p-5 bg-white border border-gray-200 rounded-xl shadow-sm">
            <h3 className="text-base font-semibold text-gray-800 mb-4 pb-2 border-b">
              {isEditing ? "Edit Model" : "Tambah Model Baru"}
            </h3>
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Contoh: Dropcore 1 Core Precon, RB4011"
                    required
                    className="block w-full px-3 py-2 mt-1 text-gray-900 bg-gray-50 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    placeholder="Contoh: FiberHome, Mikrotik"
                    required
                    className="block w-full px-3 py-2 mt-1 text-gray-900 bg-gray-50 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                  />
                </div>
              ...
              {isBulkType && (
                <div className="mt-4 pt-4 border-t border-dashed border-gray-200 bg-orange-50/50 p-4 rounded-lg">
                  <div className="mb-4">
                    <label className="block text-xs font-bold text-orange-800 mb-2 uppercase tracking-wide">
                      Strategi Stok Model Ini
                    </label>
                    ...
                    {bulkType === "measurement" && (
                      <>
                        <div className="animate-fade-in-up">
                          <label
                            htmlFor="baseUnitOfMeasure"
                            className="block text-sm font-medium text-gray-700"
                          >
                            Satuan Penggunaan (Eceran)
                          </label>
                          <div className="mt-1">
                            <CreatableSelect
                              options={commonUnits}
                          ...
                          <p className="mt-1 text-xs text-gray-500">
                            Satuan saat barang dipakai/dipotong (misal: Meter).
                          </p>
                        </div>
                        <div className="sm:col-span-2 animate-fade-in-up p-4 bg-white border border-orange-200 rounded-lg shadow-sm">
                          <label
                            ...
                            className="block text-sm font-bold text-orange-900"
                          >
                            Konversi Isi Per Kontainer
                          </label>
                          <div className="flex items-center gap-3 mt-2">
                            <span className="text-sm text-gray-600 font-medium">
                              1 {unitOfMeasure || "..."} berisi
                            </span>
                            <input
                              type="number"
                              id="quantityPerUnit"
                              ...
                              placeholder="1000"
                              min="1"
                              className="block w-32 px-3 py-2 text-gray-900 bg-white border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                            />
                            <span className="text-sm text-gray-600 font-medium">
                              {baseUnitOfMeasure || "..."}
                            </span>
                    ...
                    >
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          ...
                          {isBulkType && model.bulkType && (
                            <span
                              className={`ml-2 px-1.5 py-0.5 rounded text-[10px] font-bold ${model.bulkType === "measurement" ? "bg-purple-100 text-purple-700" : "bg-gray-200 text-gray-600"}`}
                            >
                              {model.bulkType === "measurement"
                                ? `Measurement (${model.quantityPerUnit} ${model.baseUnitOfMeasure}/${model.unitOfMeasure})`
                                : "Direct Count"}
                            </span>
                          )}
                        </p>
                      ...
                      <div className="flex items-center space-x-1">
                        <button
                          ...
                          className="p-1.5 text-gray-500 rounded-md hover:bg-yellow-100 hover:text-yellow-700"
                          title="Edit Model"
                        >
                        ...
                        <button
                          ...
                          className="p-1.5 text-gray-500 rounded-md hover:bg-red-100 hover:text-red-700"
                          title="Hapus Model"
                        >
      ...
      {modelToDelete && (
        ...
        >
          <div className="text-center">
            <div
              className={`flex items-center justify-center w-12 h-12 mx-auto rounded-full ${modelToDelete.assetCount > 0 ? "bg-amber-100 text-amber-600" : "bg-red-100 text-red-600"}`}
            >
