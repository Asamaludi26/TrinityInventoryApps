    ...
    <div className="p-4 sm:p-6 md:p-8 h-full flex flex-col">
      ...
      <div className="mb-6 border-b border-gray-200">
        <nav className="-mb-px flex space-x-8" aria-label="Tabs">
          ...
          >
            <BsTools
              className={`mr-2 h-5 w-5 ${activeTab === "asset" ? "text-primary-600" : "text-gray-400 group-hover:text-gray-500"}`}
            />
          ...
          >
            <BsLightningFill
              className={`mr-2 h-5 w-5 ${activeTab === "material" ? "text-orange-500" : "text-gray-400 group-hover:text-gray-500"}`}
            />
            Material (Massal)
          </button>
        </nav>
        ...
        {filteredCategories.length > 0 ? (
          filteredCategories.map((cat) => {
            ...
            return (
              <div
                key={cat.id}
                className="bg-white rounded-xl border border-gray-200/80 shadow-sm transition-all duration-300"
              >
                <div
                    ...
                    <div className="flex items-center gap-4 mt-2 text-sm text-gray-500">
                      ...
                      {cat.isCustomerInstallable && (
                        <Tooltip text="Dapat dipasang ke pelanggan">
                          <CustomerIcon className="w-4 h-4 text-sky-600" />
                        </Tooltip>
                      )}
                    </div>
                  </div>
                ...
                <div
                  className={`transition-all duration-500 ease-in-out overflow-hidden ${isExpanded ? "max-h-[2000px]" : "max-h-0"}`}
                >
                    ...
                    {displayTypes.length > 0 ? (
                      displayTypes.map((type) => {
                        ...
                        return (
                          <div
                            key={type.id}
                            className="bg-gray-50/70 rounded-lg border border-gray-200/80"
                          >
                            <div
                              ...
                              <div className="flex-1">
                                <div className="flex items-center gap-2">
                                  ...
                                  {isMaterial ? (
                                    ...
                                    <span className="px-1.5 py-0.5 text-[10px] font-bold text-blue-700 bg-blue-100 rounded border border-blue-200 uppercase tracking-wide">
                                      Aset
                                    </span>
                                  )}
                                </div>
                            ...
                            <div
                              className={`transition-all duration-300 ease-in-out overflow-hidden ${isTypeExpanded ? "max-h-[1000px]" : "max-h-0"}`}
                            >
      ...
      {itemToDelete && (
        ...
        >
          ...
          <div className="text-center">
            ...
            <h3 className="mt-4 text-lg font-semibold text-gray-800">
              {itemToDelete.assetCount > 0
                ? "Item Sedang Digunakan"
                : `Hapus ${itemToDelete.type}?`}
            </h3>
          ...
          <div className="flex items-center justify-end pt-5 mt-5 space-x-3 border-t">
            ...
            >
              {itemToDelete.assetCount > 0 ? "Mengerti" : "Batal"}
            </button>
            {itemToDelete.assetCount === 0 && (
              <button
    ...
    <form onSubmit={handleSubmit}>
      <div className="p-6">
        <p className="text-sm text-gray-600 mb-6 -mt-2">
          {category
            ? `Perbarui detail untuk kategori aset "${category.name}".`
            : "Isi detail untuk kategori aset baru."}
        </p>
        <div className="space-y-6">
          <div>
            ...
            <div className="relative mt-1">
              ...
              <input
                ...
                required
                className="block w-full py-2.5 pl-10 pr-3 text-gray-900 placeholder:text-gray-400 bg-gray-50 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-primary-500 sm:text-sm"
              />
            </div>
          </div>
          <div>
            ...
            <div className="flex items-start space-x-3 p-3 bg-blue-50/50 border border-blue-200/50 rounded-lg">
              <Checkbox
                id="is-customer-installable"
                checked={isCustomerInstallable}
          ...
          <div>
            <h3 className="text-base font-semibold text-gray-800 mb-2 border-b pb-2">
              Hak Akses Divisi
            </h3>
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <button
                ...
                className={`p-4 border-2 rounded-lg text-left transition-all duration-200 ${accessMode === "global" ? "bg-blue-50 border-primary-600 ring-2 ring-primary-600/50" : "bg-white border-gray-300 hover:border-primary-500"}`}
              >
              ...
              <button
                ...
                className={`p-4 border-2 rounded-lg text-left transition-all duration-200 ${accessMode === "specific" ? "bg-blue-50 border-primary-600 ring-2 ring-primary-600/50" : "bg-white border-gray-300 hover:border-primary-500"}`}
              >
                <div className="flex items-center gap-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div
              className={`transition-all duration-500 ease-in-out overflow-hidden ${accessMode === "specific" ? "max-h-96 opacity-100" : "max-h-0 opacity-0"}`}
            >
              <div className="p-4 border rounded-lg bg-gray-50/50 mt-2 space-y-3">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full h-9 py-2 pl-9 pr-4 text-sm text-gray-900 bg-white border border-gray-300 rounded-lg shadow-sm focus:ring-primary-500 focus:border-primary-500"
                  />
                </div>
                  ...
                  >
                    <Checkbox
                      ...
                      checked={
                        ...
                        associatedDivisions.length === filteredDivisions.length
                      }
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 max-h-40 overflow-y-auto custom-scrollbar pr-2 -mr-2">
                  {filteredDivisions.map((division) => (
                    ...
                    >
                      <Checkbox
                        ...
                        checked={associatedDivisions.includes(division.id)}
                        onChange={() => handleDivisionToggle(division.id)}
                      />
                      <label
                        htmlFor={`division-toggle-${division.id}`}
                  ...
                  {filteredDivisions.length === 0 && (
                    <p className="text-sm text-gray-400 sm:col-span-2 text-center py-2">
      ...
      <div className="flex items-center justify-end px-6 py-4 space-x-3 bg-gray-50 border-t">
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="inline-flex items-center justify-center px-4 py-2 text-sm font-semibold text-white bg-primary-600 rounded-lg shadow-sm hover:bg-primary-700 disabled:bg-primary-600/70"
        >
