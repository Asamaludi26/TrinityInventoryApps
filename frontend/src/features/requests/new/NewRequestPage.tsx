...
const NewRequestPage: React.FC<NewRequestPageProps> = ({
  ...
  const [lockedAllocation, setLockedAllocation] =
  ...
  // PREFILL DATA STATE
  const [rawPrefillItems, setRawPrefillItems] = useState<
    | {
        name: string;
        brand: string;
        currentStock?: number;
  ...
  useEffect(() => {
    if (initialFilters) {
      ...
      const prefillItems =
        initialFilters.prefillItems ||
        (initialFilters.prefillItem ? [initialFilters.prefillItem] : null);
        ...
        <div className="p-4 sm:p-6 md:p-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
            <div className="flex items-center gap-4">
              <button
                ...
                className="flex items-center justify-center w-10 h-10 bg-white border border-gray-200 rounded-full text-gray-500 hover:text-primary-600 hover:border-primary-600 transition-all shadow-sm"
                aria-label="Kembali"
              >
          ...
          <div className="p-8 bg-white rounded-2xl shadow-xl border border-gray-200">
            <RequestForm
              ...
              initialOrderType={
                rawPrefillItems && rawPrefillItems.length > 0
                  ? "Urgent"
                  : undefined
              }
          ...
          <div className="flex flex-col md:flex-row justify-between md:items-center gap-4 mb-6">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-6 py-2.5 bg-primary-600 text-white rounded-xl text-sm font-bold shadow-lg shadow-primary-600/30 hover:scale-105 active:scale-95 transition-all"
              >
                Buat Baru
              </button>
            </div>
          ...
          {hasExistingDraft && (
            <div className="mb-6 p-1 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl shadow-lg shadow-blue-200/50 dark:shadow-blue-900/30 animate-fade-in-up">
              <div className="bg-white dark:bg-slate-800 p-4 rounded-[0.9rem] flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <button
                  onClick={() => setView("form")}
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-primary-600 text-white rounded-xl text-xs font-black hover:bg-primary-700 transition-all"
                >
        ...
        >
          <div className="text-center py-6">
            ...
            <p className="text-sm text-gray-600 px-4">
              ...
              permintaan{" "}
              <strong className="text-gray-900">#{selectedRequest.id}</strong>?
            </p>
          </div>
          <div className="flex justify-end gap-3 p-4 border-t bg-gray-50">
            ...
            <button
              ...
              className="px-6 py-2 bg-primary-600 text-white rounded-lg text-sm font-bold shadow-md"
            >
              Kirim Sekarang
            </button>
          </div>
